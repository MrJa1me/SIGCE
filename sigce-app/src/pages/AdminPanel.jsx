...
function AdminPanel() {
  ...
  const loadStats = useCallback(async () => {
    if (!online) {
      setStats(null);
      setStatsError('Sin conexión — las estadísticas requieren el servidor');
    ...
    setStatsError('');
    try {
      setStats(await getAdminStats(14));
    } catch (err) {
  ...
  return (
    <div className="page-container">
      ...
      <div className="admin-tabs">
        ...
        >
          <Icon name="clipboard" size="sm" /> Resumen
        </button>
        <button
          type="button"
        ...
        <>
          <div className="stats-grid">
            ...
            <div className="stat-card accepted-stat">
              ...
              <span className="stat-icon"><Icon name="traveler" size="md" /></span>
            </div>
            <div className="stat-card review-stat">
              ...
              <span className="stat-icon"><Icon name="user" size="md" /></span>
            </div>
            <div className="stat-card pending-stat">
              <span className="stat-number">{users.filter(u => u.role === 'admin').length}</span>
              <span className="stat-label">Administradores</span>
              <span className="stat-icon"><Icon name="admin" size="md" /></span>
            </div>
          </div>
                ...
                <div className="form-row">
                  ...
                  <div className="form-group">
                    ...
                    <select value={form.role} onChange={e => setForm(f => ({ ...f, role: e.target.value }))}>
                      <option value="traveler">{ROLE_LABELS.traveler}</option>
                      <option value="official">{ROLE_LABELS.official} de Aduana</option>
                    ...
                    <tr key={u.id}>
                      ...
                      <td>
                        <span className="role-badge" style={{
                          ...
                          borderColor: (ROLE_COLORS[u.role] || '#666') + '40',
                        }}>
                      ...
                      <td className="actions-cell">
                        ...
                        <button className="btn btn-sm btn-reject" onClick={() => handleDelete(u)} disabled={!online || u.id === 1} title="Eliminar">
                          <Icon name="x" size="sm" />
                        </button>
                      </td>
                    </tr>
